% Getting x values from -3 to 3 in intervals of 0.02
x = -3:0.02:3;
...
xlabel('x-values');
ylabel('Amplitude');
title('Filtering Sine Waves (f = 0.3)');
...
% Doing this all again for f = 0.6
f = 0.6;
...
xlabel('x-values');
ylabel('Amplitude');
title('Filtering Sine Waves (f = 0.6)');
legend('Original','Corrupted','Moving Median Filter','Moving Average Filter','Moving Quartile Filter');
